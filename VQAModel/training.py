...
# Hyperparameters
input_size = 768
num_classes = 1548 # Change this to the actual number of classe
...
checkpoint_prefix = f"vqa_model_{num_heads}h_{dropout_prob}dropout"
...
for epoch in range(start_epoch, num_epochs):
    ...
    results_df.to_csv(f"results_{num_heads}h_{dropout_prob}dropout.csv", index=False)
